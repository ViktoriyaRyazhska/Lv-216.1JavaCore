...
public class Employee {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + departamentNumber;
	...
	public boolean equals(Object obj) {
		...
		if (departamentNumber != other.departamentNumber)
			return false;
		if (name == null) {
			if (other.name != null)
				return false;
	...
	public String toString() {
		return "Employee [name=" + name + ", departamentNumber=" + departamentNumber + ", salary=" + salary + "]";
	}
